...
public sealed class LoggingBehavior<TRequest, TResponse>(IApplicationLogger<LoggingBehavior<TRequest, TResponse>> logger) : IPipelineBehavior<TRequest, TResponse> where TRequest : notnull
{
