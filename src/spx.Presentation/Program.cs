...
using spx.Application;
using spx.Application.Abstractions;
using spx.Infrastructure;
using spx.Persistence;
using spx.Presentation;
using spx.Presentation.Authentication;
using spx.Presentation.Authorization;
using spx.Presentation.Filters;
using spx.Presentation.Middleware;
...
Log.Logger = new LoggerConfiguration()
    ...
    .Enrich.WithProperty("Application", "spx")
    .WriteTo.Console()
    .WriteTo.File(
...
try
{
    ...
    builder.Services.AddScoped<spx.Application.Services.IAuthenticationService, ConfiguredAuthenticationService>();
